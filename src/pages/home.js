        ...
        <Background>
          ...
          <Header>
            <Header.Wrapper>
              ...
              <Header.Nav>
                <Header.List>
                  <Header.Item className="animate-delay--100">
                    <Header.Link href="#">HOME</Header.Link>
                  </Header.Item>
                  <Header.Item className="animate-delay--200">
                    <Header.Link href="#">PAGES</Header.Link>
                  </Header.Item>
                  <Header.Item className="animate-delay--300">
                    <Header.Link href="#">OUR OFFER</Header.Link>
                  </Header.Item>
                  <Header.Item className="animate-delay--400">
                    <Header.Link href="#">PRICING</Header.Link>
                  </Header.Item>
                  <Header.Item className="animate-delay--500">
